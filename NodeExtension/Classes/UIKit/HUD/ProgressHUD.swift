...
extension MBProgressHUD {
    public static var dl_textSize: CGFloat = 12.0
    public static var dl_textColor: UIColor = .white
    public static var dl_blurEffectStyle: UIBlurEffect.Style = .dark
    public static var dl_backgroundTintColor: UIColor = .lightGray
    public static var dl_contentMargin: CGFloat = 10.0
    ...
    public static var dl_successDismissedDelay: TimeInterval = 2.0
    public static var dl_failureDismissedDelay: TimeInterval = 3.0
    public static var dl_graceTime: TimeInterval = 0.0
    ...
    public static func dl_showOnlyText(_ text: String?,
                                       superView: UIView,
                                       completion: MBProgressHUDCompletionBlock? = nil) -> MBProgressHUD? {
        ...
        hud.bezelView.blurEffectStyle = dl_blurEffectStyle
        hud.bezelView.color = dl_backgroundTintColor
    ...
    public static func dl_showIndicator(superView: UIView,
                                        isOverlayInteractionEnabled: Bool = true,
                                        completion: MBProgressHUDCompletionBlock? = nil) -> MBProgressHUD {
        let hud = MBProgressHUD.showAdded(to: _containerViewWrapedIfNeeded(view: superView), animated: true)
        hud.completionBlock = completion
...
public class SuccessShapeView: UIView {
    ...
    private func setup() {
        ...
        let circlePath = UIBezierPath(arcCenter: center,
                                      ...
                                      endAngle: CGFloat(Double.pi * 7 / 2),
                                      clockwise: true)
